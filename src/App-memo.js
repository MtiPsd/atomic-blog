...
// * if you click on showArchive, it will take
// * exactly the same time as before, because
// * memoizing has nothing to do with `state and context`
// * but only with PROPS
const Archive = memo(function Archive({ archiveOptions }) {
  ...
  const [posts] = useState(() =>
    ...
    Array.from({ length: 30_000 }, () => createRandomPost()),
  );
